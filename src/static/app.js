document.addEventListener("DOMContentLoaded", () => {
          ...
          details.participants.forEach(participant => {
            participantsHTML += `
              <li>
                ...
                <span class="delete-icon" data-activity="${name}" data-email="${participant}" title="Unregister participant">🗑️</span>
              </li>
            `;
          });
          participantsHTML += '</ul>';
  ...
  async function unregisterParticipant(activityName, email) {
    if (!confirm(`Êtes-vous sûr de vouloir désinscrire ${email} de ${activityName} ?`)) {
      return;
    }
